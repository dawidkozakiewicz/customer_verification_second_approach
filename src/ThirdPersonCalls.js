...
const ThirdPersonCalls = () => {
    ...
    return (
        <div>
            <h3 style={{ backgroundColor: state.backgroundColorColor }}>KONTAKT OSOBY TRZECIEJ</h3>
            <h3 style={{ backgroundColor: state.backgroundColorColor }}>WYMAGANA WERYFIKACJA DODATKOWA</h3>
